...
x_range = linspace(0, 6, x_samples);
...
save 'Q-2b-node-Chebychev pivot L30 with samples x20 y10 c250 t25 c3e-21to0 err1e-9on1e-2'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%