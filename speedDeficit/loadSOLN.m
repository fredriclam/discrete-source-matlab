% Loads SOLN* files generated by (July 2017 version) C++ 3-D propagation
% code. Regular expressions to get parameters from header in file. Saves
% raw data to field "R". Called in SOLN_build_data &
% SOLN_build_data_with_plot (legacy version)
